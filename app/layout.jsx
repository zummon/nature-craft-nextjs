	...
	return (
		<html>
			<body>
				<div
					className={`${
						pathname == "/" ? "py-20 lg:py-40" : "py-10 lg:py-20"
					} bg-zinc-800 text-zinc-50 bg-cover bg-fixed bg-blend-soft-light bg-center`}
					style={{
						backgroundImage:
						...
						<div className="ml-auto lg:w-2/3">
							...
							<div className="flex flex-wrap gap-5 items-center">
								{pathname !== "/" && (
									<div className="">
										<Link className="" href="/">
											<span className="sr-only">uikit icon home</span>
											<svg
												className=""
												width="40"
												height="40"
								...
								<Link
									href="/blog"
									className="inline-block bg-white text-black px-10 py-4 shadow-md hover:bg-zinc-100 focus:bg-zinc-100"
								>
									Blogs
								</Link>
								<Link
									href="/#about"
									className="inline-block border border-zinc-400 px-7 py-2 hover:border-white focus:border-white"
								>
									About
								</Link>
								<Link
									href="/#donate"
									className="inline-block hover:underline focus:underline underline-offset-4"
								>
									Donate
								</Link>
							</div>
				...
				<div className="py-10 lg:py-20 bg-zinc-50">{children}</div>

				<div
					className="py-10 lg:py-20 bg-zinc-800 text-zinc-50 bg-cover bg-fixed bg-blend-soft-light bg-center"
					style={{
						backgroundImage:
				...
				>
					<div className="max-w-5xl mx-auto">
						<div className="divide-y sm:divide-x sm:divide-y-0 grid md:grid-cols-3 sm:grid-cols-2 divide-white divide-opacity-20">
							<div className="p-8">
								<h3 className="text-2xl mb-4">List</h3>
							...
							<div className="p-8">
								<h3 className="text-2xl mb-4">Paragraph</h3>
								<p className="">
									<a className="" href="https://zummon.page/" target="_blank">
							...
							<div className="p-8 text-white">
								<a
									href="#"
									className="mr-3 mb-3 rounded-full p-2 bg-white bg-opacity-20 hover:bg-opacity-40 inline-block"
								>
